...
typedef enum {RED = 0, GREEN, BLUE, PURPLE, WHITE, YELLOW, BLACK} COLOR; 
extern bool markColor( Cloud& , COLOR);
extern bool markColor(pcl::PointCloud<pcl::PointXYZRGB>& , COLOR);
extern bool markColor(Cloud&, vector<int>& indices, COLOR); 
extern bool markColor(cv::Mat&, vector<int>& , COLOR ); 
